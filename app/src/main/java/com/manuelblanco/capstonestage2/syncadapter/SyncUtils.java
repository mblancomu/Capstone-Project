...
package com.manuelblanco.capstonestage2.syncadapter;
...
public class SyncUtils {
    ...
    private static final String CONTENT_AUTHORITY = ContractTripsProvider.AUTHORITY;
    private static final String PREF_SETUP_COMPLETE = "setup_complete";
    // Value below must match the account type specified in res/xml/syncadapter.xml
    public static final String ACCOUNT_TYPE = "com.manuelblanco.capstonestage2.account";
    ...
    public static void TriggerRefresh() {
        ...
        ContentResolver.requestSync(
                ...
                ContractTripsProvider.AUTHORITY,                 // Content authority
                b);                                             // Extras
    }
}
